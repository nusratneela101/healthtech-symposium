...
'<!DOCTYPE html><html><head><meta charset="UTF-8"><style>body{font-family:Arial,sans-serif;background:#f4f4f4;margin:0;padding:0}.wrap{max-width:600px;margin:0 auto;background:#fff}.header{background:linear-gradient(135deg,#0a1628,#1a237e);padding:40px 30px;text-align:center}.header img{width:280px;background:white;padding:12px 16px;border-radius:6px;margin-bottom:12px}.header p{color:rgba(255,255,255,.7);margin:8px 0 0;font-size:14px}.body{padding:30px}.body h2{color:#0d6efd}.body p{color:#555;line-height:1.7}.cta{text-align:center;margin:30px 0}.cta a{background:#0d6efd;color:#fff;padding:14px 32px;text-decoration:none;border-radius:8px;font-weight:bold;display:inline-block}.footer{background:#f9f9f9;padding:20px;text-align:center;font-size:12px;color:#999}</style></head><body><div class="wrap"><div class="header"><img src="https://yourdomain.com/healthtech/assets/images/cfts-logo.svg" alt="Canada FinTech Symposium"><p>April 21–22, 2026 — Toronto, Canada</p></div><div class="body"><h2>Dear {{first_name}},</h2><p>As <strong>{{role}}</strong> at <strong>{{company}}</strong>, your expertise in driving FinTech innovation in {{city}} makes you an ideal participant for Canada''s premier FinTech gathering.</p><p>Join <strong>500+ C-Suite executives, investors, and technology leaders</strong> for two days of keynotes, workshops, and networking opportunities that will shape the future of finance in Canada.</p><div class="cta"><a href="https://yourdomain.com/healthtech/register">Register Your Seat Now</a></div><p>Spaces are extremely limited. Secure your spot today.</p><p><em>Igniting the Future of Finance</em></p><p>Best regards,<br><strong>Canada FinTech Symposium Team</strong><br>sm@101bdtech.com</p></div><div class="footer"><p>You received this email because your profile matches our event criteria.<br><a href="{{unsubscribe_link}}">Unsubscribe</a></p></div></div></body></html>',
1
);
